...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=889.2.&lawCode=WIC).
</Note>

**Code:** Welfare and Institutions Code (`WIC`) · **Section:** `889.2` · **UID:** `WIC:24-889.2`

**Location:** 2. CHILDREN > 2. Juvenile Court Law > 24. Wards and Dependent Children—Juvenile Homes, Ranches and Camps

**Citation:** WIC § 889.2 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=889.2.&lawCode=WIC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=889.2.&lawCode=WIC)
...
(History: Amended by Stats. 2023, Ch. 48, Sec. 93. (SB 114) Effective July 10, 2023.)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=889.2.&lawCode=WIC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=889.2.&lawCode=WIC)

---

[← WIC § 889.1](/codes/wic/24-889.1) · [WIC § 891 →](/codes/wic/24-891) · [Browse Welfare and Institutions Code](/codes/wic) · [Search corpus](/codes/search)
