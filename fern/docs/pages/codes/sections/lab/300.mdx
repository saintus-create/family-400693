---
title: "LAB § 300"
description: "(a) As used in this section, the phrase “assignment of wages” includes the sale or assignment of, or giving of an order for, wages or salary but does not…"
slug: codes/lab/300
position: 368
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=300.&lawCode=LAB).
</Note>

**Code:** Labor Code (`LAB`) · **Section:** `300` · **UID:** `LAB:300`

**Location:** 2. EMPLOYMENT REGULATION AND SUPERVISION > 2. Assignment of Wages

**Citation:** LAB § 300 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=300.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=300.&lawCode=LAB)
...
- **Hierarchy path:** `2. EMPLOYMENT REGULATION AND SUPERVISION > 2. Assignment of Wages`

- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=300.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=300.&lawCode=LAB)

---

[← LAB § 281](/codes/lab/4-281) · [LAB § 350 →](/codes/lab/1-350) · [Browse Labor Code](/codes/lab) · [Search corpus](/codes/search)
