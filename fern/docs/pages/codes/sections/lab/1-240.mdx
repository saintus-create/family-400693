---
title: "LAB § 240"
description: "(a) If any employer has been convicted of a violation of any provision of this article, or if any judgment against an employer for nonpayment of wages…"
slug: codes/lab/1-240
position: 335
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=240.&lawCode=LAB).
</Note>

**Code:** Labor Code (`LAB`) · **Section:** `240` · **UID:** `LAB:1-240`

**Location:** 2. EMPLOYMENT REGULATION AND SUPERVISION > 1. Payment of Wages > 1. General Occupations

**Citation:** LAB § 240 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=240.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=240.&lawCode=LAB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=240.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=240.&lawCode=LAB)

---

[← LAB § 238.10](/codes/lab/1-238.10) · [LAB § 243 →](/codes/lab/1-243) · [Browse Labor Code](/codes/lab) · [Search corpus](/codes/search)
