---
title: "LAB § 243"
description: "(a) If, within 10 years of either a conviction for a violation of this article or failing to satisfy a judgment for nonpayment of wages, or of both, it is…"
slug: codes/lab/1-243
position: 336
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=243.&lawCode=LAB).
</Note>

**Code:** Labor Code (`LAB`) · **Section:** `243` · **UID:** `LAB:1-243`

**Location:** 2. EMPLOYMENT REGULATION AND SUPERVISION > 1. Payment of Wages > 1. General Occupations

**Citation:** LAB § 243 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=243.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=243.&lawCode=LAB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=243.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=243.&lawCode=LAB)

---

[← LAB § 240](/codes/lab/1-240) · [LAB § 244 →](/codes/lab/1-244) · [Browse Labor Code](/codes/lab) · [Search corpus](/codes/search)
