---
title: "LAB § 90.3"
description: "(a) It is the policy of this state to vigorously enforce the laws requiring employers to secure the payment of compensation as required by Section 3700 and…"
slug: codes/lab/90.3
position: 91
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=90.3.&lawCode=LAB).
</Note>

**Code:** Labor Code (`LAB`) · **Section:** `90.3` · **UID:** `LAB:90.3`

**Location:** 1. DEPARTMENT OF INDUSTRIAL RELATIONS > 4. Division of Labor Standards Enforcement

**Citation:** LAB § 90.3 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=90.3.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=90.3.&lawCode=LAB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=90.3.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=90.3.&lawCode=LAB)

---

[← LAB § 90.2](/codes/lab/90.2) · [LAB § 90.5 →](/codes/lab/90.5) · [Browse Labor Code](/codes/lab) · [Search corpus](/codes/search)
