---
title: "LAB § 4660"
description: "This section shall only apply to injuries occurring before January 1, 2013. (a) In determining the percentages of permanent disability, account shall be…"
slug: codes/lab/3-4660
position: 1730
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4660.&lawCode=LAB).
</Note>

**Code:** Labor Code (`LAB`) · **Section:** `4660` · **UID:** `LAB:3-4660`

**Location:** 4. WORKERS' COMPENSATION AND INSURANCE > 2. Compensation Schedules > 3. Disability Payments

**Citation:** LAB § 4660 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4660.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4660.&lawCode=LAB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4660.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4660.&lawCode=LAB)

---

[← LAB § 4659](/codes/lab/3-4659) · [LAB § 4660.1 →](/codes/lab/3-4660.1) · [Browse Labor Code](/codes/lab) · [Search corpus](/codes/search)
