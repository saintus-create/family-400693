---
title: "LAB § 201.8"
description: "(a) As used in this section, the following terms have the following meanings: (1) “Events employee” means an employee of an owner, operator, affiliate…"
slug: codes/lab/1-201.8
position: 253
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=201.8.&lawCode=LAB).
</Note>

**Code:** Labor Code (`LAB`) · **Section:** `201.8` · **UID:** `LAB:1-201.8`

**Location:** 2. EMPLOYMENT REGULATION AND SUPERVISION > 1. Payment of Wages > 1. General Occupations

**Citation:** LAB § 201.8 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=201.8.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=201.8.&lawCode=LAB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=201.8.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=201.8.&lawCode=LAB)

---

[← LAB § 201.7](/codes/lab/1-201.7) · [LAB § 201.9 →](/codes/lab/1-201.9) · [Browse Labor Code](/codes/lab) · [Search corpus](/codes/search)
