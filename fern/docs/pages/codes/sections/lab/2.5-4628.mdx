---
title: "LAB § 4628"
description: "(a) Except as provided in subdivision (c), no person, other than the physician who signs the medical-legal report, except a nurse performing those functions…"
slug: codes/lab/2.5-4628
position: 1710
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4628.&lawCode=LAB).
</Note>

**Code:** Labor Code (`LAB`) · **Section:** `4628` · **UID:** `LAB:2.5-4628`

**Location:** 4. WORKERS' COMPENSATION AND INSURANCE > 2. Compensation Schedules > 2.5. Medical-Legal Expenses

**Citation:** LAB § 4628 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4628.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4628.&lawCode=LAB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4628.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4628.&lawCode=LAB)

---

[← LAB § 4627](/codes/lab/2.5-4627) · [LAB § 4650 →](/codes/lab/3-4650) · [Browse Labor Code](/codes/lab) · [Search corpus](/codes/search)
