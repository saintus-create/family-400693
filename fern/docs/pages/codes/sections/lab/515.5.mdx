---
title: "LAB § 515.5"
description: "(a) Except as provided in subdivision (b), an employee in the computer software field shall be exempt from the requirement that an overtime rate of…"
slug: codes/lab/515.5
position: 411
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=515.5.&lawCode=LAB).
</Note>

**Code:** Labor Code (`LAB`) · **Section:** `515.5` · **UID:** `LAB:515.5`

**Location:** 2. EMPLOYMENT REGULATION AND SUPERVISION > 1. General

**Citation:** LAB § 515.5 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=515.5.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=515.5.&lawCode=LAB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=515.5.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=515.5.&lawCode=LAB)

---

[← LAB § 515](/codes/lab/515) · [LAB § 515.6 →](/codes/lab/515.6) · [Browse Labor Code](/codes/lab) · [Search corpus](/codes/search)
