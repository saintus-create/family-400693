---
title: "LAB § 1771.7"
description: "(a) (1) For contracts specified in subdivision (f), an awarding body that chooses to use funds derived from either the Kindergarten-University Public…"
slug: codes/lab/2-1771.7
position: 1033
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1771.7.&lawCode=LAB).
</Note>

**Code:** Labor Code (`LAB`) · **Section:** `1771.7` · **UID:** `LAB:2-1771.7`

**Location:** 2. EMPLOYMENT REGULATION AND SUPERVISION > 1. Public Works > 2. Wages

**Citation:** LAB § 1771.7 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1771.7.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1771.7.&lawCode=LAB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1771.7.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1771.7.&lawCode=LAB)

---

[← LAB § 1771.6](/codes/lab/2-1771.6) · [LAB § 1771.8 →](/codes/lab/2-1771.8) · [Browse Labor Code](/codes/lab) · [Search corpus](/codes/search)
