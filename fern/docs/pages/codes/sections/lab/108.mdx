---
title: "LAB § 108"
description: "(a) The Division of Labor Standards Enforcement shall do all of the following: (1) Maintain minimum standards for the competency and training of…"
slug: codes/lab/108
position: 138
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=108.&lawCode=LAB).
</Note>

**Code:** Labor Code (`LAB`) · **Section:** `108` · **UID:** `LAB:108`

**Location:** 1. DEPARTMENT OF INDUSTRIAL RELATIONS > 4.5. Electrician Certification

**Citation:** LAB § 108 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=108.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=108.&lawCode=LAB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=108.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=108.&lawCode=LAB)

---

[← LAB § 107.7.2](/codes/lab/107.7.2) · [LAB § 108.2 →](/codes/lab/108.2) · [Browse Labor Code](/codes/lab) · [Search corpus](/codes/search)
