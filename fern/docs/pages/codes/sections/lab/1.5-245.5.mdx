---
title: "LAB § 245.5"
description: "As used in this article: (a) “Employee” does not include the following: (1) Except as provided in subdivision (d) of Section 246.5, an employee covered by a…"
slug: codes/lab/1.5-245.5
position: 339
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=245.5.&lawCode=LAB).
</Note>

**Code:** Labor Code (`LAB`) · **Section:** `245.5` · **UID:** `LAB:1.5-245.5`

**Location:** 2. EMPLOYMENT REGULATION AND SUPERVISION > 1. Payment of Wages > 1.5. Paid Sick Days

**Citation:** LAB § 245.5 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=245.5.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=245.5.&lawCode=LAB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=245.5.&lawCode=LAB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=245.5.&lawCode=LAB)

---

[← LAB § 245](/codes/lab/1.5-245) · [LAB § 246 →](/codes/lab/1.5-246) · [Browse Labor Code](/codes/lab) · [Search corpus](/codes/search)
