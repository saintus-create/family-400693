---
title: "CORP § 800"
description: "(a) As used in this section, “corporation” includes an unincorporated association; “board” includes the managing body of an unincorporated association…"
slug: codes/corp/800
position: 217
---
...
<Note>
Snapshot updated by the state: **November 27, 2025** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=800.&lawCode=CORP).
</Note>

**Code:** Corporations Code (`CORP`) · **Section:** `800` · **UID:** `CORP:800`

**Location:** 1. GENERAL CORPORATION LAW > 1. CORPORATIONS > 8. Shareholder Derivative Actions

**Citation:** CORP § 800 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=800.&lawCode=CORP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=800.&lawCode=CORP)
...
- **Hierarchy path:** `1. CORPORATIONS > 1. GENERAL CORPORATION LAW > 8. Shareholder Derivative Actions`

- **Division / Part / Chapter / Article:** 1. GENERAL CORPORATION LAW > 1. CORPORATIONS > 8. Shareholder Derivative Actions

- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=800.&lawCode=CORP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=800.&lawCode=CORP)

---

[← CORP § 711](/codes/corp/711) · [CORP § 900 →](/codes/corp/900) · [Browse Corporations Code](/codes/corp) · [Search corpus](/codes/search)
