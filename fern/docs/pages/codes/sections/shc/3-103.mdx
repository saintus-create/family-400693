---
title: "SHC § 103"
description: "(a) As used in this section, the following terms have the following meanings: (1) “Multimodal” means transportation options within a transportation…"
slug: codes/shc/3-103
position: 127
---
...
<Note>
Snapshot updated by the state: **July 17, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=103.&lawCode=SHC).
</Note>

**Code:** Streets and Highways Code (`SHC`) · **Section:** `103` · **UID:** `SHC:3-103`

**Location:** 1. STATE HIGHWAYS > 1. Administration > 3. The Department of Transportation

**Citation:** SHC § 103 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=103.&lawCode=SHC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=103.&lawCode=SHC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=103.&lawCode=SHC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=103.&lawCode=SHC)

---

[← SHC § 102](/codes/shc/3-102) · [SHC § 103.5 →](/codes/shc/3-103.5) · [Browse Streets and Highways Code](/codes/shc) · [Search corpus](/codes/search)
