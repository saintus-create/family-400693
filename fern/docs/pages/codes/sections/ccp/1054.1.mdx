---
title: "CCP § 1054.1"
description: "(a) When an act to be done in any action or proceeding in any court of this state or before any state administrative agency, as provided by law or rule…"
slug: codes/ccp/1054.1
position: 2162
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1054.1.&lawCode=CCP).
</Note>

**Code:** Code of Civil Procedure (`CCP`) · **Section:** `1054.1` · **UID:** `CCP:1054.1`

**Location:** 14. OF MISCELLANEOUS PROVISIONS > 7. General Provisions

**Citation:** CCP § 1054.1 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1054.1.&lawCode=CCP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1054.1.&lawCode=CCP)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1054.1.&lawCode=CCP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1054.1.&lawCode=CCP)

---

[← CCP § 1054](/codes/ccp/1054) · [CCP § 1055 →](/codes/ccp/1055) · [Browse Code of Civil Procedure](/codes/ccp) · [Search corpus](/codes/search)
