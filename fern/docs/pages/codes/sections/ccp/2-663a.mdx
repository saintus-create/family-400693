---
title: "CCP § 663a"
description: "(a) A party intending to make a motion to set aside and vacate a judgment, as described in Section 663, shall file with the clerk and serve upon the adverse…"
slug: codes/ccp/2-663a
position: 1037
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=663a.&lawCode=CCP).
</Note>

**Code:** Code of Civil Procedure (`CCP`) · **Section:** `663a` · **UID:** `CCP:2-663a`

**Location:** 8. OF THE TRIAL AND JUDGMENT IN CIVIL ACTIONS > 7. Provisions Relating to Trials in General > 2. New Trials

**Citation:** CCP § 663a · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=663a.&lawCode=CCP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=663a.&lawCode=CCP)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=663a.&lawCode=CCP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=663a.&lawCode=CCP)

---

[← CCP § 663.2](/codes/ccp/2-663.2) · [CCP § 664 →](/codes/ccp/664) · [Browse Code of Civil Procedure](/codes/ccp) · [Search corpus](/codes/search)
