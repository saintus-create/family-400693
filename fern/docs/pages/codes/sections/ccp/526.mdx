---
title: "CCP § 526"
description: "(a) An injunction may be granted in the following cases: (1) When it appears by the complaint that the plaintiff is entitled to the relief demanded, and the…"
slug: codes/ccp/526
position: 854
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=526.&lawCode=CCP).
</Note>

**Code:** Code of Civil Procedure (`CCP`) · **Section:** `526` · **UID:** `CCP:526`

**Location:** 7. OTHER PROVISIONAL REMEDIES IN CIVIL ACTIONS > 3. Injunction

**Citation:** CCP § 526 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=526.&lawCode=CCP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=526.&lawCode=CCP)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=526.&lawCode=CCP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=526.&lawCode=CCP)

---

[← CCP § 525](/codes/ccp/525) · [CCP § 526a →](/codes/ccp/526a) · [Browse Code of Civil Procedure](/codes/ccp) · [Search corpus](/codes/search)
