---
title: "CCP § 845"
description: "(a) The court may appoint one or more special masters whose duties may include the following: (1) Investigating technical and legal issues, as directed by…"
slug: codes/ccp/12-845
position: 1770
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=845.&lawCode=CCP).
</Note>

**Code:** Code of Civil Procedure (`CCP`) · **Section:** `845` · **UID:** `CCP:12-845`

**Location:** 10. ACTIONS IN PARTICULAR CASES > 7. Actions Relating to Groundwater Rights > 12. Special Master

**Citation:** CCP § 845 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=845.&lawCode=CCP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=845.&lawCode=CCP)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=845.&lawCode=CCP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=845.&lawCode=CCP)

---

[← CCP § 844](/codes/ccp/11-844) · [CCP § 846 →](/codes/ccp/12-846) · [Browse Code of Civil Procedure](/codes/ccp) · [Search corpus](/codes/search)
