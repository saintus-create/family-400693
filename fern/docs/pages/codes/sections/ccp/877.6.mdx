---
title: "CCP § 877.6"
description: "(a) (1) Any party to an action in which it is alleged that two or more parties are joint tortfeasors or co-obligors on a contract debt shall be entitled to…"
slug: codes/ccp/877.6
position: 1942
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=877.6.&lawCode=CCP).
</Note>

**Code:** Code of Civil Procedure (`CCP`) · **Section:** `877.6` · **UID:** `CCP:877.6`

**Location:** 11. CONTRIBUTION AMONG JOINT JUDGMENT DEBTORS > 1. Releases From and Contribution Among Joint Tortfeasors

**Citation:** CCP § 877.6 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=877.6.&lawCode=CCP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=877.6.&lawCode=CCP)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=877.6.&lawCode=CCP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=877.6.&lawCode=CCP)

---

[← CCP § 877.5](/codes/ccp/877.5) · [CCP § 878 →](/codes/ccp/878) · [Browse Code of Civil Procedure](/codes/ccp) · [Search corpus](/codes/search)
