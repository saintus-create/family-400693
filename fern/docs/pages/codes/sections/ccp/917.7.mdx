---
title: "CCP § 917.7"
description: "The perfecting of an appeal shall not stay proceedings as to those provisions of a judgment or order which award, change, or otherwise affect the custody…"
slug: codes/ccp/917.7
position: 1973
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=917.7.&lawCode=CCP).
</Note>

**Code:** Code of Civil Procedure (`CCP`) · **Section:** `917.7` · **UID:** `CCP:917.7`

**Location:** 13. APPEALS IN CIVIL ACTIONS > 2. Stay of Enforcement and Other Proceedings

**Citation:** CCP § 917.7 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=917.7.&lawCode=CCP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=917.7.&lawCode=CCP)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=917.7.&lawCode=CCP](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=917.7.&lawCode=CCP)

---

[← CCP § 917.6](/codes/ccp/917.6) · [CCP § 917.8 →](/codes/ccp/917.8) · [Browse Code of Civil Procedure](/codes/ccp) · [Search corpus](/codes/search)
