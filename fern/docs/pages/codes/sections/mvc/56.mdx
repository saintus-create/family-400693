---
title: "MVC § 56"
description: "(a) This section shall be known, and may be cited, as the “California Military Whistleblower Protection Act.” (b) Notwithstanding any other law, a person…"
slug: codes/mvc/56
position: 27
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=56.&lawCode=MVC).
</Note>

**Code:** Military and Veterans Code (`MVC`) · **Section:** `56` · **UID:** `MVC:56`

**Location:** 1. ADMINISTRATION OF MILITARY AND VETERANS AFFAIRS > 1. The Military Department

**Citation:** MVC § 56 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=56.&lawCode=MVC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=56.&lawCode=MVC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=56.&lawCode=MVC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=56.&lawCode=MVC)

---

[← MVC § 55](/codes/mvc/55) · [MVC § 56.1 →](/codes/mvc/56.1) · [Browse Military and Veterans Code](/codes/mvc) · [Search corpus](/codes/search)
