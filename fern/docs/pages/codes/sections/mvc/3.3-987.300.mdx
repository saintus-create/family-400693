---
title: "MVC § 987.300"
description: "(a) If a qualified entity is unable to locate, match, or otherwise place a qualified tenant in a qualified unit within 28 days of the qualified unit…"
slug: codes/mvc/3.3-987.300
position: 679
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=987.300.&lawCode=MVC).
</Note>

**Code:** Military and Veterans Code (`MVC`) · **Section:** `987.300` · **UID:** `MVC:3.3-987.300`

**Location:** 4. VETERANS' AID AND WELFARE > 6. State Benefits for Veterans > 3.3. Supportive Housing for Veterans Funded by Tax Credits and Private Activity Bonds

**Citation:** MVC § 987.300 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=987.300.&lawCode=MVC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=987.300.&lawCode=MVC)
...
- **Hierarchy path:** `4. VETERANS' AID AND WELFARE > 6. State Benefits for Veterans > 3.3. Supportive Housing for Veterans Funded by Tax Credits and Private Activity Bonds`

- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=987.300.&lawCode=MVC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=987.300.&lawCode=MVC)

---

[← MVC § 987.93](/codes/mvc/3.1-987.93-2) · [MVC § 987.566 →](/codes/mvc/3.1-987.566) · [Browse Military and Veterans Code](/codes/mvc) · [Search corpus](/codes/search)
