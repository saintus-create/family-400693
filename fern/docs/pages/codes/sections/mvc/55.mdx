---
title: "MVC § 55"
description: "(a) A person serving in the position of inspector general shall satisfy all of the following requirements: (1) Be appointed by the Governor, with…"
slug: codes/mvc/55
position: 26
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=55.&lawCode=MVC).
</Note>

**Code:** Military and Veterans Code (`MVC`) · **Section:** `55` · **UID:** `MVC:55`

**Location:** 1. ADMINISTRATION OF MILITARY AND VETERANS AFFAIRS > 1. The Military Department

**Citation:** MVC § 55 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=55.&lawCode=MVC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=55.&lawCode=MVC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=55.&lawCode=MVC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=55.&lawCode=MVC)

---

[← MVC § 54](/codes/mvc/54) · [MVC § 56 →](/codes/mvc/56) · [Browse Military and Veterans Code](/codes/mvc) · [Search corpus](/codes/search)
