---
title: "MVC § 412.5"
description: "(a) Notwithstanding any other law, the Adjutant General may do all of the following: (1) Establish support programs, including, but not limited to, morale…"
slug: codes/mvc/1-412.5
position: 298
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=412.5.&lawCode=MVC).
</Note>

**Code:** Military and Veterans Code (`MVC`) · **Section:** `412.5` · **UID:** `MVC:1-412.5`

**Location:** 2. THE MILITARY FORCES OF THE STATE > 8. Equipment and Accommodations > 1. Funds, Arms, and Equipment

**Citation:** MVC § 412.5 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=412.5.&lawCode=MVC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=412.5.&lawCode=MVC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=412.5.&lawCode=MVC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=412.5.&lawCode=MVC)

---

[← MVC § 412](/codes/mvc/1-412) · [MVC § 413 →](/codes/mvc/1-413) · [Browse Military and Veterans Code](/codes/mvc) · [Search corpus](/codes/search)
