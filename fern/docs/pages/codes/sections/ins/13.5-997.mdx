---
title: "INS § 997"
description: "(a) For statement purposes as defined in Article 10 (commencing with Section 900), for insolvency calculations as defined in Article 13 (commencing with…"
slug: codes/ins/13.5-997
position: 776
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=997.&lawCode=INS).
</Note>

**Code:** Insurance Code (`INS`) · **Section:** `997` · **UID:** `INS:13.5-997`

**Location:** 1. GENERAL RULES GOVERNING INSURANCE > 2. THE BUSINESS OF INSURANCE > 1. General Regulations > 13.5. Disability Insurance Reserves

**Citation:** INS § 997 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=997.&lawCode=INS](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=997.&lawCode=INS)
...
- **Hierarchy path:** `1. GENERAL RULES GOVERNING INSURANCE > 2. THE BUSINESS OF INSURANCE > 1. General Regulations > 13.5. Disability Insurance Reserves`

- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=997.&lawCode=INS](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=997.&lawCode=INS)

---

[← INS § 995.7](/codes/ins/13.3-995.7) · [INS § 1010 →](/codes/ins/14-1010) · [Browse Insurance Code](/codes/ins) · [Search corpus](/codes/search)
