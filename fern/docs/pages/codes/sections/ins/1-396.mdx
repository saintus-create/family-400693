---
title: "INS § 396"
description: "(a) An insurer shall do either of the following: (1) Maintain a verifiable process that allows a policyholder to designate in writing or by electronic…"
slug: codes/ins/1-396
position: 162
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=396.&lawCode=INS).
</Note>

**Code:** Insurance Code (`INS`) · **Section:** `396` · **UID:** `INS:1-396`

**Location:** 1. GENERAL RULES GOVERNING INSURANCE > 1. THE CONTRACT > 4. The Policy > 1. Definition and Scope

**Citation:** INS § 396 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=396.&lawCode=INS](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=396.&lawCode=INS)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=396.&lawCode=INS](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=396.&lawCode=INS)

---

[← INS § 395](/codes/ins/1-395) · [INS § 410 →](/codes/ins/2-410) · [Browse Insurance Code](/codes/ins) · [Search corpus](/codes/search)
