---
title: "INS § 1729.2"
description: "(a) An applicant or licensee shall notify the commissioner when any of the background information set forth in this section changes after the application…"
slug: codes/ins/12-1729.2
position: 1337
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1729.2.&lawCode=INS).
</Note>

**Code:** Insurance Code (`INS`) · **Section:** `1729.2` · **UID:** `INS:12-1729.2`

**Location:** 1. GENERAL RULES GOVERNING INSURANCE > 2. THE BUSINESS OF INSURANCE > 5. Production Agencies > 12. Conduct of Licensee

**Citation:** INS § 1729.2 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1729.2.&lawCode=INS](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1729.2.&lawCode=INS)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1729.2.&lawCode=INS](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1729.2.&lawCode=INS)

---

[← INS § 1729](/codes/ins/12-1729) · [INS § 1729.5 →](/codes/ins/12-1729.5) · [Browse Insurance Code](/codes/ins) · [Search corpus](/codes/search)
