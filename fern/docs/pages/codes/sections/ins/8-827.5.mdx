---
title: "INS § 827.5"
description: "The term “insurer” as used in this section shall not include domestic insurers as defined in Section 26. The following transactions of an insurer described…"
slug: codes/ins/8-827.5
position: 599
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=827.5.&lawCode=INS).
</Note>

**Code:** Insurance Code (`INS`) · **Section:** `827.5` · **UID:** `INS:8-827.5`

**Location:** 1. GENERAL RULES GOVERNING INSURANCE > 2. THE BUSINESS OF INSURANCE > 1. General Regulations > 8. Issue of Securities

**Citation:** INS § 827.5 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=827.5.&lawCode=INS](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=827.5.&lawCode=INS)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=827.5.&lawCode=INS](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=827.5.&lawCode=INS)

---

[← INS § 827.3](/codes/ins/8-827.3) · [INS § 827.6 →](/codes/ins/8-827.6) · [Browse Insurance Code](/codes/ins) · [Search corpus](/codes/search)
