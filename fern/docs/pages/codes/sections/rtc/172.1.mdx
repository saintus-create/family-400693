---
title: "RTC § 172.1"
description: "(a) To claim tax relief in accordance with the provisions of this chapter, the owner shall execute a declaration under penalty of perjury that the replaced…"
slug: codes/rtc/172.1
position: 289
---
...
<Note>
Snapshot updated by the state: **August 19, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=172.1.&lawCode=RTC).
</Note>

**Code:** Revenue and Taxation Code (`RTC`) · **Section:** `172.1` · **UID:** `RTC:172.1`

**Location:** 1. PROPERTY TAXATION > 1. GENERAL PROVISIONS > 2.6. Disaster Relief for Manufactured Homes

**Citation:** RTC § 172.1 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=172.1.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=172.1.&lawCode=RTC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=172.1.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=172.1.&lawCode=RTC)

---

[← RTC § 172](/codes/rtc/172) · [RTC § 175 →](/codes/rtc/175) · [Browse Revenue and Taxation Code](/codes/rtc) · [Search corpus](/codes/search)
