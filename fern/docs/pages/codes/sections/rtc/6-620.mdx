---
title: "RTC § 620"
description: "If the assessor does not send a notice pursuant to Section 619 or 621 to an assessee whose property was not on the prior year’s secured roll, or to an…"
slug: codes/rtc/6-620
position: 761
---
...
<Note>
Snapshot updated by the state: **August 19, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=620.&lawCode=RTC).
</Note>

**Code:** Revenue and Taxation Code (`RTC`) · **Section:** `620` · **UID:** `RTC:6-620`

**Location:** 1. PROPERTY TAXATION > 2. ASSESSMENT > 3. Assessment Generally > 6. Assessment Roll

**Citation:** RTC § 620 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=620.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=620.&lawCode=RTC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=620.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=620.&lawCode=RTC)

---

[← RTC § 619.2](/codes/rtc/6-619.2) · [RTC § 621 →](/codes/rtc/6-621) · [Browse Revenue and Taxation Code](/codes/rtc) · [Search corpus](/codes/search)
