---
title: "RTC § 51"
description: "(a) For purposes of subdivision (b) of Section 2 of Article XIIIA of the California Constitution, for each lien date after the lien date in which the base…"
slug: codes/rtc/51
position: 46
---
...
<Note>
Snapshot updated by the state: **August 19, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=51.&lawCode=RTC).
</Note>

**Code:** Revenue and Taxation Code (`RTC`) · **Section:** `51` · **UID:** `RTC:51`

**Location:** 1. PROPERTY TAXATION > 0.5. IMPLEMENTATION OF ARTICLE XIII A OF THE CALIFORNIA CONSTITUTION > 1. Base Year Values

**Citation:** RTC § 51 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=51.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=51.&lawCode=RTC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=51.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=51.&lawCode=RTC)

---

[← RTC § 50](/codes/rtc/50) · [RTC § 51.5 →](/codes/rtc/51.5) · [Browse Revenue and Taxation Code](/codes/rtc) · [Search corpus](/codes/search)
