---
title: "RTC § 995.2"
description: "The term “basic operational program,” as used in Section 995, means a computer program that is fundamental and necessary to the functioning of a computer. A…"
slug: codes/rtc/1-995.2
position: 835
---
...
<Note>
Snapshot updated by the state: **August 19, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=995.2.&lawCode=RTC).
</Note>

**Code:** Revenue and Taxation Code (`RTC`) · **Section:** `995.2` · **UID:** `RTC:1-995.2`

**Location:** 1. PROPERTY TAXATION > 2. ASSESSMENT > 5. Special Types of Property > 1. Generally

**Citation:** RTC § 995.2 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=995.2.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=995.2.&lawCode=RTC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=995.2.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=995.2.&lawCode=RTC)

---

[← RTC § 995](/codes/rtc/1-995) · [RTC § 996 →](/codes/rtc/1-996) · [Browse Revenue and Taxation Code](/codes/rtc) · [Search corpus](/codes/search)
