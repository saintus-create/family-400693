---
title: "RTC § 6295"
description: "(a) (1) Except as provided in subdivision (h), when a motor vehicle required to be registered under the Vehicle Code, except for a recreational vehicle that…"
slug: codes/rtc/3-6295
position: 1995
---
...
<Note>
Snapshot updated by the state: **August 19, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6295.&lawCode=RTC).
</Note>

**Code:** Revenue and Taxation Code (`RTC`) · **Section:** `6295` · **UID:** `RTC:3-6295`

**Location:** 2. OTHER TAXES > 1. SALES AND USE TAXES > 3.5. Vehicles, Vessels and Aircraft > 3. Auxiliary Collection Provisions

**Citation:** RTC § 6295 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6295.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6295.&lawCode=RTC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6295.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6295.&lawCode=RTC)

---

[← RTC § 6294](/codes/rtc/3-6294) · [RTC § 6351 →](/codes/rtc/1-6351) · [Browse Revenue and Taxation Code](/codes/rtc) · [Search corpus](/codes/search)
