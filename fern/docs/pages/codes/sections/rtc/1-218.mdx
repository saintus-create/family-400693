---
title: "RTC § 218"
description: "(a) The homeowners’ property tax exemption is in the amount of the assessed value of the dwelling specified in this section, as authorized by subdivision…"
slug: codes/rtc/1-218
position: 504
---
...
<Note>
Snapshot updated by the state: **August 19, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=218.&lawCode=RTC).
</Note>

**Code:** Revenue and Taxation Code (`RTC`) · **Section:** `218` · **UID:** `RTC:1-218`

**Location:** 1. PROPERTY TAXATION > 2. ASSESSMENT > 1. Taxation Base > 1. Taxable and Exempt Property

**Citation:** RTC § 218 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=218.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=218.&lawCode=RTC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=218.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=218.&lawCode=RTC)

---

[← RTC § 217.1](/codes/rtc/1-217.1) · [RTC § 218.2 →](/codes/rtc/1-218.2) · [Browse Revenue and Taxation Code](/codes/rtc) · [Search corpus](/codes/search)
