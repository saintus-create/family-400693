---
title: "RTC § 423.7"
description: "(a) When valuing open-space land subject to a wildlife habitat contract, as defined in subdivision (f) of Section 421, the board, for purposes of surveys…"
slug: codes/rtc/1.5-423.7
position: 650
---
...
<Note>
Snapshot updated by the state: **August 19, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=423.7.&lawCode=RTC).
</Note>

**Code:** Revenue and Taxation Code (`RTC`) · **Section:** `423.7` · **UID:** `RTC:1.5-423.7`
...
**Citation:** RTC § 423.7 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=423.7.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=423.7.&lawCode=RTC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=423.7.&lawCode=RTC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=423.7.&lawCode=RTC)

---

[← RTC § 423.5](/codes/rtc/1.5-423.5) · [RTC § 423.8 →](/codes/rtc/1.5-423.8) · [Browse Revenue and Taxation Code](/codes/rtc) · [Search corpus](/codes/search)
