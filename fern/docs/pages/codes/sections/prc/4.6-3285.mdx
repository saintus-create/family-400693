---
title: "PRC § 3285"
description: "(a) Every operator shall submit to the division by July 1, 2025, a sensitive receptor inventory and map that includes the following: (1) A list of all…"
slug: codes/prc/4.6-3285
position: 498
---
...
<Note>
Snapshot updated by the state: **August 29, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3285.&lawCode=PRC).
</Note>

**Code:** Public Resources Code (`PRC`) · **Section:** `3285` · **UID:** `PRC:4.6-3285`

**Location:** 3. OIL AND GAS > 1. Oil and Gas Conservation > 4.6. Health Protection Zones

**Citation:** PRC § 3285 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3285.&lawCode=PRC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3285.&lawCode=PRC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3285.&lawCode=PRC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3285.&lawCode=PRC)

---

[← PRC § 3284](/codes/prc/4.6-3284) · [PRC § 3286 →](/codes/prc/4.6-3286) · [Browse Public Resources Code](/codes/prc) · [Search corpus](/codes/search)
