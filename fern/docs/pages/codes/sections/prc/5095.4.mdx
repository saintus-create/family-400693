---
title: "PRC § 5095.4"
description: "(a) The director, in consultation with the State Department of Education, shall develop a competitive grant program to assist state parks, state…"
slug: codes/prc/5095.4
position: 1896
---
...
<Note>
Snapshot updated by the state: **August 29, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5095.4.&lawCode=PRC).
</Note>

**Code:** Public Resources Code (`PRC`) · **Section:** `5095.4` · **UID:** `PRC:5095.4`

**Location:** 5. PARKS AND MONUMENTS > 1.55. State Urban Parks and Healthy Communities Act

**Citation:** PRC § 5095.4 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5095.4.&lawCode=PRC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5095.4.&lawCode=PRC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5095.4.&lawCode=PRC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5095.4.&lawCode=PRC)

---

[← PRC § 5095.3](/codes/prc/5095.3) · [PRC § 5095.5 →](/codes/prc/5095.5) · [Browse Public Resources Code](/codes/prc) · [Search corpus](/codes/search)
