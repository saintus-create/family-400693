---
title: "BPC § 6034.1"
description: "(a) Any entity of the State Bar of California exploring a regulatory sandbox shall do all of the following: (1) Prioritize protecting individuals…"
slug: codes/bpc/2-6034.1
position: 3896
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6034.1.&lawCode=BPC).
</Note>

**Code:** Business and Professions Code (`BPC`) · **Section:** `6034.1` · **UID:** `BPC:2-6034.1`

**Location:** 3. PROFESSIONS AND VOCATIONS GENERALLY > 4. Attorneys > 2. Administration

**Citation:** BPC § 6034.1 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6034.1.&lawCode=BPC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6034.1.&lawCode=BPC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6034.1.&lawCode=BPC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6034.1.&lawCode=BPC)

---

[← BPC § 6034](/codes/bpc/2-6034) · [BPC § 6035 →](/codes/bpc/2.5-6035) · [Browse Business and Professions Code](/codes/bpc) · [Search corpus](/codes/search)
