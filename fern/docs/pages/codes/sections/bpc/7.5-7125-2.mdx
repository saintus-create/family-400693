...
**Code:** Business and Professions Code (`BPC`) · **Section:** `7125` · **UID:** `BPC:7.5-7125#2`
...
[← BPC § 7125](/codes/bpc/7.5-7125) · [BPC § 7125.1 →](/codes/bpc/7.5-7125.1) · [Browse Business and Professions Code](/codes/bpc) · [Search corpus](/codes/search)
