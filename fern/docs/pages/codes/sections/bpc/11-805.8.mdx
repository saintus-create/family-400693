---
title: "BPC § 805.8"
description: "(a) As used in this section, the following terms shall have the following meanings: (1) “Agency” means the relevant state licensing agency with regulatory…"
slug: codes/bpc/11-805.8
position: 385
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=805.8.&lawCode=BPC).
</Note>

**Code:** Business and Professions Code (`BPC`) · **Section:** `805.8` · **UID:** `BPC:11-805.8`

**Location:** 2. HEALING ARTS > 1. General Provisions > 11. Professional Reporting

**Citation:** BPC § 805.8 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=805.8.&lawCode=BPC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=805.8.&lawCode=BPC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=805.8.&lawCode=BPC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=805.8.&lawCode=BPC)

---

[← BPC § 805.7](/codes/bpc/11-805.7) · [BPC § 805.9 →](/codes/bpc/11-805.9) · [Browse Business and Professions Code](/codes/bpc) · [Search corpus](/codes/search)
