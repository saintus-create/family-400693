---
title: "BPC § 512"
description: "(a) Except as provided in subdivisions (b) and (c), no contract that is issued, amended, renewed, or delivered on or after January 1, 1999, between any…"
slug: codes/bpc/1.5-512
position: 278
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=512.&lawCode=BPC).
</Note>

**Code:** Business and Professions Code (`BPC`) · **Section:** `512` · **UID:** `BPC:1.5-512`

**Location:** 2. HEALING ARTS > 1. General Provisions > 1.5. Advocacy for Appropriate Health Care

**Citation:** BPC § 512 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=512.&lawCode=BPC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=512.&lawCode=BPC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=512.&lawCode=BPC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=512.&lawCode=BPC)

---

[← BPC § 511.4](/codes/bpc/1.5-511.4) · [BPC § 525 →](/codes/bpc/2-525) · [Browse Business and Professions Code](/codes/bpc) · [Search corpus](/codes/search)
