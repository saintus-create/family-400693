---
title: "BPC § 809.2"
description: "If a licentiate timely requests a hearing concerning a final proposed action for which a report is required to be filed under Section 805, the following…"
slug: codes/bpc/11-809.2
position: 393
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=809.2.&lawCode=BPC).
</Note>

**Code:** Business and Professions Code (`BPC`) · **Section:** `809.2` · **UID:** `BPC:11-809.2`

**Location:** 2. HEALING ARTS > 1. General Provisions > 11. Professional Reporting

**Citation:** BPC § 809.2 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=809.2.&lawCode=BPC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=809.2.&lawCode=BPC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=809.2.&lawCode=BPC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=809.2.&lawCode=BPC)

---

[← BPC § 809.1](/codes/bpc/11-809.1) · [BPC § 809.3 →](/codes/bpc/11-809.3) · [Browse Business and Professions Code](/codes/bpc) · [Search corpus](/codes/search)
