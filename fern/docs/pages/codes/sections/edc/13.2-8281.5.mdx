---
title: "EDC § 8281.5"
description: "(a) The California Prekindergarten Planning and Implementation Grant Program is hereby established as a state early learning initiative with the goal of…"
slug: codes/edc/13.2-8281.5
position: 627
---
...
<Note>
Snapshot updated by the state: **July 18, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=8281.5.&lawCode=EDC).
</Note>

**Code:** Education Code (`EDC`) · **Section:** `8281.5` · **UID:** `EDC:13.2-8281.5`

**Location:** 1. GENERAL EDUCATION CODE PROVISIONS > 6. EDUCATION PROGRAMS—STATE MASTER PLANS > 1. GENERAL EDUCATION CODE PROVISIONS > 2. Early Education Act > 13.2. California Prekindergarten Planning and Implementation Grant Program

**Citation:** EDC § 8281.5 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=8281.5.&lawCode=EDC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=8281.5.&lawCode=EDC)
...
- **Hierarchy path:** `1. GENERAL EDUCATION CODE PROVISIONS > 1. GENERAL EDUCATION CODE PROVISIONS > 6. EDUCATION PROGRAMS—STATE MASTER PLANS > 2. Early Education Act > 13.2. California Prekindergarten Planning and Implementation Grant Program`

- **Division / Part / Chapter / Article:** 1. GENERAL EDUCATION CODE PROVISIONS > 6. EDUCATION PROGRAMS—STATE MASTER PLANS > 1. GENERAL EDUCATION CODE PROVISIONS > 2. Early Education Act > 13.2. California Prekindergarten Planning and Implementation Grant Program

- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=8281.5.&lawCode=EDC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=8281.5.&lawCode=EDC)

---

[← EDC § 8272.5](/codes/edc/8-8272.5) · [EDC § 8283 →](/codes/edc/10-8283) · [Browse Education Code](/codes/edc) · [Search corpus](/codes/search)
