...
<Note>
Snapshot updated by the state: **July 17, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=12410.&lawCode=WAT).
</Note>

**Code:** Water Code (`WAT`) · **Section:** `12410` · **UID:** `WAT:2-12410`

**Location:** 6. CONSERVATION, DEVELOPMENT, AND UTILIZATION OF STATE WATER RESOURCES > 2. Statewide Water Data Integration > 2. Statewide Integrated Water Data Platform Creation

**Citation:** WAT § 12410 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=12410.&lawCode=WAT](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=12410.&lawCode=WAT)
...
- **Hierarchy path:** `6. CONSERVATION, DEVELOPMENT, AND UTILIZATION OF STATE WATER RESOURCES > 2. Statewide Water Data Integration > 2. Statewide Integrated Water Data Platform Creation`

- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=12410.&lawCode=WAT](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=12410.&lawCode=WAT)

---

[← WAT § 12406](/codes/wat/1-12406) · [WAT § 12415 →](/codes/wat/3-12415) · [Browse Water Code](/codes/wat) · [Search corpus](/codes/search)
