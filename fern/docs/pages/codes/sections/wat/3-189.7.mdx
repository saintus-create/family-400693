---
title: "WAT § 189.7"
description: "(a) Outreach to identify issues of environmental justice needs to begin as early as possible in state board or regional board planning, policy, and…"
slug: codes/wat/3-189.7
position: 121
---
...
<Note>
Snapshot updated by the state: **July 17, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=189.7.&lawCode=WAT).
</Note>

**Code:** Water Code (`WAT`) · **Section:** `189.7` · **UID:** `WAT:3-189.7`

**Location:** 1. GENERAL STATE POWERS OVER WATER > 2. State Administration Generally > 3. State Water Resources Control Board

**Citation:** WAT § 189.7 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=189.7.&lawCode=WAT](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=189.7.&lawCode=WAT)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=189.7.&lawCode=WAT](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=189.7.&lawCode=WAT)

---

[← WAT § 189.5](/codes/wat/3-189.5) · [WAT § 190 →](/codes/wat/4-190) · [Browse Water Code](/codes/wat) · [Search corpus](/codes/search)
