---
title: "FAM § 7906.5"
description: "(a) Within 60 days after an officer or agency of this state, or its political subdivision, receives a request from another state to conduct a study of a…"
slug: codes/fam/7906.5
position: 1255
---
...
<Note>
Snapshot updated by the state: **November 27, 2025** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=7906.5.&lawCode=FAM).
</Note>

**Code:** Family Code (`FAM`) · **Section:** `7906.5` · **UID:** `FAM:7906.5`

**Location:** 12. PARENT AND CHILD RELATIONSHIP > 5. INTERSTATE COMPACT ON PLACEMENT OF CHILDREN

**Citation:** FAM § 7906.5 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=7906.5.&lawCode=FAM](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=7906.5.&lawCode=FAM)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=7906.5.&lawCode=FAM](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=7906.5.&lawCode=FAM)

---

[← FAM § 7906](/codes/fam/7906) · [FAM § 7907 →](/codes/fam/7907) · [Browse Family Code](/codes/fam) · [Search corpus](/codes/search)
