---
title: "PEN § 1276.5"
description: "(a) At the time of an initial application to a bail bond licensee for a bail bond which is to be secured by a lien against real property, the bail bond…"
slug: codes/pen/1-1276.5
position: 2394
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1276.5.&lawCode=PEN).
</Note>

**Code:** Penal Code (`PEN`) · **Section:** `1276.5` · **UID:** `PEN:1-1276.5`

**Location:** 10. MISCELLANEOUS PROCEEDINGS > 1. Bail > 1. In What Cases the Defendant May Be Admitted to Bail

**Citation:** PEN § 1276.5 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1276.5.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1276.5.&lawCode=PEN)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1276.5.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1276.5.&lawCode=PEN)

---

[← PEN § 1276.1](/codes/pen/1-1276.1) · [PEN § 1277 →](/codes/pen/2-1277) · [Browse Penal Code](/codes/pen) · [Search corpus](/codes/search)
