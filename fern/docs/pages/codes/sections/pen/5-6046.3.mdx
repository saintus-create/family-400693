---
title: "PEN § 6046.3"
description: "(a) The board shall administer a competitive grant program to carry out the purposes of this article that focuses on community-based solutions for reducing…"
slug: codes/pen/5-6046.3
position: 3731
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6046.3.&lawCode=PEN).
</Note>

**Code:** Penal Code (`PEN`) · **Section:** `6046.3` · **UID:** `PEN:5-6046.3`

**Location:** 7. ADMINISTRATION OF THE STATE CORRECTIONAL SYSTEM > 5. The Corrections Standards Authority > 5. Second Chance Program

**Citation:** PEN § 6046.3 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6046.3.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6046.3.&lawCode=PEN)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6046.3.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6046.3.&lawCode=PEN)

---

[← PEN § 6046.2](/codes/pen/5-6046.2) · [PEN § 6048 →](/codes/pen/7-6048) · [Browse Penal Code](/codes/pen) · [Search corpus](/codes/search)
