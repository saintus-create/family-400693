---
title: "PEN § 241"
description: "(a) An assault is punishable by a fine not exceeding one thousand dollars ($1,000), or by imprisonment in the county jail not exceeding six months, or by…"
slug: codes/pen/241
position: 318
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=241.&lawCode=PEN).
</Note>

**Code:** Penal Code (`PEN`) · **Section:** `241` · **UID:** `PEN:241`

**Location:** 8. OF CRIMES AGAINST THE PERSON > 9. Assault and Battery

**Citation:** PEN § 241 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=241.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=241.&lawCode=PEN)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=241.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=241.&lawCode=PEN)

---

[← PEN § 240](/codes/pen/240) · [PEN § 241.1 →](/codes/pen/241.1) · [Browse Penal Code](/codes/pen) · [Search corpus](/codes/search)
