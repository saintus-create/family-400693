---
title: "PEN § 992"
description: "(a) (1) In any case in which the defendant is charged with a felony, the court shall require the defendant to provide a right thumbprint on a form developed…"
slug: codes/pen/992
position: 1854
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=992.&lawCode=PEN).
</Note>

**Code:** Penal Code (`PEN`) · **Section:** `992` · **UID:** `PEN:992`

**Location:** 6. PLEADINGS AND PROCEEDINGS BEFORE TRIAL > 1. Of the Arraignment of the Defendant

**Citation:** PEN § 992 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=992.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=992.&lawCode=PEN)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=992.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=992.&lawCode=PEN)

---

[← PEN § 991](/codes/pen/991) · [PEN § 993 →](/codes/pen/993) · [Browse Penal Code](/codes/pen) · [Search corpus](/codes/search)
