---
title: "PEN § 17"
description: "(a) A felony is a crime that is punishable with death, by imprisonment in the state prison, or, notwithstanding any other law, by imprisonment in a county…"
slug: codes/pen/17
position: 17
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=17.&lawCode=PEN).
</Note>

**Code:** Penal Code (`PEN`) · **Section:** `17` · **UID:** `PEN:17`

**Location:** OF. THE ACT

**Citation:** PEN § 17 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=17.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=17.&lawCode=PEN)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=17.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=17.&lawCode=PEN)

---

[← PEN § 16](/codes/pen/16) · [PEN § 17.2 →](/codes/pen/17.2) · [Browse Penal Code](/codes/pen) · [Search corpus](/codes/search)
