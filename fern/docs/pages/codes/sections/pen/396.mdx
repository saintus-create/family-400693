---
title: "PEN § 396"
description: "(a) The Legislature hereby finds that during a state of emergency or local emergency, including, but not limited to, an earthquake, flood, fire, riot…"
slug: codes/pen/396
position: 721
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=396.&lawCode=PEN).
</Note>

**Code:** Penal Code (`PEN`) · **Section:** `396` · **UID:** `PEN:396`

**Location:** 10. OF CRIMES AGAINST THE PUBLIC HEALTH AND SAFETY

**Citation:** PEN § 396 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=396.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=396.&lawCode=PEN)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=396.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=396.&lawCode=PEN)

---

[← PEN § 395](/codes/pen/395) · [PEN § 396.5 →](/codes/pen/396.5) · [Browse Penal Code](/codes/pen) · [Search corpus](/codes/search)
