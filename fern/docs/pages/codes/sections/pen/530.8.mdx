---
title: "PEN § 530.8"
description: "(a) If a person discovers that an application in their name for a loan, credit line or account, credit card, charge card, public utility service, mail…"
slug: codes/pen/530.8
position: 966
---
...
<Note>
Snapshot updated by the state: **July 21, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=530.8.&lawCode=PEN).
</Note>

**Code:** Penal Code (`PEN`) · **Section:** `530.8` · **UID:** `PEN:530.8`

**Location:** 13. OF CRIMES AGAINST PROPERTY > 8. False Personation and Cheats

**Citation:** PEN § 530.8 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=530.8.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=530.8.&lawCode=PEN)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=530.8.&lawCode=PEN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=530.8.&lawCode=PEN)

---

[← PEN § 530.7](/codes/pen/530.7) · [PEN § 530.55 →](/codes/pen/530.55) · [Browse Penal Code](/codes/pen) · [Search corpus](/codes/search)
