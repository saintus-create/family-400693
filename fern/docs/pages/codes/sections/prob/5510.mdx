---
title: "PROB § 5510"
description: "(a) A registering entity offering to accept registrations in beneficiary form may establish the terms and conditions under which it will receive requests…"
slug: codes/prob/5510
position: 1252
---
...
<Note>
Snapshot updated by the state: **November 27, 2025** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5510.&lawCode=PROB).
</Note>

**Code:** Probate Code (`PROB`) · **Section:** `5510` · **UID:** `PROB:5510`

**Location:** 5. NONPROBATE TRANSFERS > 3. UNIFORM TOD SECURITY REGISTRATION ACT

**Citation:** PROB § 5510 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5510.&lawCode=PROB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5510.&lawCode=PROB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5510.&lawCode=PROB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5510.&lawCode=PROB)

---

[← PROB § 5509](/codes/prob/5509) · [PROB § 5511 →](/codes/prob/5511) · [Browse Probate Code](/codes/prob) · [Search corpus](/codes/search)
