---
title: "PROB § 6132"
description: "(a) Notwithstanding any other provision, a will may refer to a writing that directs disposition of tangible personal property not otherwise specifically…"
slug: codes/prob/6132
position: 1327
---
...
<Note>
Snapshot updated by the state: **November 27, 2025** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6132.&lawCode=PROB).
</Note>

**Code:** Probate Code (`PROB`) · **Section:** `6132` · **UID:** `PROB:6132`

**Location:** 6. WILLS AND INTESTATE SUCCESSION > 1. WILLS > 4. Reference to Matters Outside the Will

**Citation:** PROB § 6132 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6132.&lawCode=PROB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6132.&lawCode=PROB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6132.&lawCode=PROB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=6132.&lawCode=PROB)

---

[← PROB § 6131](/codes/prob/6131) · [PROB § 6200 →](/codes/prob/1-6200) · [Browse Probate Code](/codes/prob) · [Search corpus](/codes/search)
