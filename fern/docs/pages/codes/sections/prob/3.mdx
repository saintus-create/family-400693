...
<Note>
Snapshot updated by the state: **November 27, 2025** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3.&lawCode=PROB).
</Note>

**Code:** Probate Code (`PROB`) · **Section:** `3` · **UID:** `PROB:3`

**Location:** 1. PRELIMINARY PROVISIONS AND DEFINITIONS > 1. PRELIMINARY PROVISIONS

**Citation:** PROB § 3 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3.&lawCode=PROB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3.&lawCode=PROB)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3.&lawCode=PROB](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3.&lawCode=PROB)

---

[← PROB § 2](/codes/prob/2) · [PROB § 4 →](/codes/prob/4) · [Browse Probate Code](/codes/prob) · [Search corpus](/codes/search)
