---
title: "PUC § 769.3"
description: "(a) For purposes of this section, the following definitions apply: (1) “Community choice aggregator” has the same meaning as defined in Section 331.1. (2)…"
slug: codes/puc/3-769.3
position: 609
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=769.3.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `769.3` · **UID:** `PUC:3-769.3`
...
**Citation:** PUC § 769.3 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=769.3.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=769.3.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=769.3.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=769.3.&lawCode=PUC)

---

[← PUC § 769.2](/codes/puc/3-769.2) · [PUC § 769.5 →](/codes/puc/3-769.5) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
