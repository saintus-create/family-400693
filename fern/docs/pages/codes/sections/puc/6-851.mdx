---
title: "PUC § 851"
description: "(a) Except as provided in subdivision (c), a public utility, other than a common carrier by railroad subject to Part A of the Interstate Commerce Act (49…"
slug: codes/puc/6-851
position: 713
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=851.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `851` · **UID:** `PUC:6-851`
...
**Citation:** PUC § 851 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=851.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=851.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=851.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=851.&lawCode=PUC)

---

[← PUC § 850.8](/codes/puc/5.8-850.8) · [PUC § 852 →](/codes/puc/6-852) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
