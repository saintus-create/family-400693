---
title: "PUC § 744"
description: "(a) As used in this section, “agricultural producer” means any person or corporation whose principal purpose is the agrarian production of food or fiber…"
slug: codes/puc/2-744
position: 570
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=744.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `744` · **UID:** `PUC:2-744`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 4. Regulation of Public Utilities > 2. Rates

**Citation:** PUC § 744 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=744.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=744.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=744.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=744.&lawCode=PUC)

---

[← PUC § 743.3](/codes/puc/2-743.3) · [PUC § 744.5 →](/codes/puc/2-744.5) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
