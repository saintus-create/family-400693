---
title: "PUC § 394.4"
description: "Rules that implement the following minimum standards shall be adopted by the commission for electric service providers offering electrical services to…"
slug: codes/puc/12-394.4
position: 263
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=394.4.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `394.4` · **UID:** `PUC:12-394.4`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 2.3. Electrical Restructuring > 12. Consumer Protection

**Citation:** PUC § 394.4 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=394.4.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=394.4.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=394.4.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=394.4.&lawCode=PUC)

---

[← PUC § 394.3](/codes/puc/12-394.3) · [PUC § 394.5 →](/codes/puc/12-394.5) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
