---
title: "PUC § 489"
description: "(a) The commission shall, by rule or order, require every public utility other than a common carrier to file with the commission within the time and in the…"
slug: codes/puc/2-489
position: 397
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=489.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `489` · **UID:** `PUC:2-489`
...
**Citation:** PUC § 489 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=489.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=489.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=489.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=489.&lawCode=PUC)

---

[← PUC § 488](/codes/puc/2-488) · [PUC § 490 →](/codes/puc/2-490) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
