---
title: "PUC § 3292"
description: "(a) If, no later than July 27, 2019, each large electrical corporation not subject to an insolvency proceeding on July 12, 2019, notifies the commission of…"
slug: codes/puc/3292
position: 1407
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3292.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `3292` · **UID:** `PUC:3292`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 6. Wildfire > 3. Operation of the Fund

**Citation:** PUC § 3292 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3292.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3292.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3292.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3292.&lawCode=PUC)

---

[← PUC § 3291](/codes/puc/3291) · [PUC § 3293 →](/codes/puc/3293) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
