---
title: "PUC § 5860"
description: "(a) The holder of a state franchise that offers video service within the jurisdiction of the local entity shall calculate and remit to the local entity a…"
slug: codes/puc/5860
position: 1651
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5860.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `5860` · **UID:** `PUC:5860`

**Location:** 2.5. THE DIGITAL INFRASTRUCTURE AND VIDEO COMPETITION ACT OF 2006

**Citation:** PUC § 5860 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5860.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5860.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5860.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5860.&lawCode=PUC)

---

[← PUC § 5850](/codes/puc/5850) · [PUC § 5870 →](/codes/puc/5870) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
