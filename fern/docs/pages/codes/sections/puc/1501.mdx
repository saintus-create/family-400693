---
title: "PUC § 1501"
description: "The Legislature recognizes the substantial obligation undertaken by a privately owned public utility which is franchised under the Constitution or by a…"
slug: codes/puc/1501
position: 979
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1501.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `1501` · **UID:** `PUC:1501`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 8.5. Service Duplication

**Citation:** PUC § 1501 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1501.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1501.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1501.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1501.&lawCode=PUC)

---

[← PUC § 1421](/codes/puc/1421) · [PUC § 1502 →](/codes/puc/1502) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
