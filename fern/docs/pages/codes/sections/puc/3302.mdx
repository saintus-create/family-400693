---
title: "PUC § 3302"
description: "As used in this division, unless the context otherwise requires, the following terms have the following meanings: (a) “Act” means the California Consumer…"
slug: codes/puc/3302
position: 1430
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3302.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `3302` · **UID:** `PUC:3302`

**Location:** 1.5. CALIFORNIA CONSUMER POWER AND CONSERVATION FINANCING AUTHORITY ACT > 1. General Provisions and Definitions

**Citation:** PUC § 3302 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3302.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3302.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3302.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3302.&lawCode=PUC)

---

[← PUC § 3301](/codes/puc/3301) · [PUC § 3304 →](/codes/puc/3304) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
