---
title: "PUC § 740.12"
description: "(a) (1) The Legislature finds and declares all of the following: (A) Advanced clean vehicles and fuels are needed to reduce petroleum use, to meet air…"
slug: codes/puc/2-740.12
position: 550
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=740.12.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `740.12` · **UID:** `PUC:2-740.12`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 4. Regulation of Public Utilities > 2. Rates

**Citation:** PUC § 740.12 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=740.12.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=740.12.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=740.12.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=740.12.&lawCode=PUC)

---

[← PUC § 740.11](/codes/puc/2-740.11) · [PUC § 740.13 →](/codes/puc/2-740.13) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
