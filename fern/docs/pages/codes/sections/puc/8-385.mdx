---
title: "PUC § 385"
description: "(a) Each local publicly owned electric utility shall establish a nonbypassable, usage based charge on local distribution service of not less than the lowest…"
slug: codes/puc/8-385
position: 250
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=385.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `385` · **UID:** `PUC:8-385`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 2.3. Electrical Restructuring > 8. Publicly Owned Utilities

**Citation:** PUC § 385 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=385.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=385.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=385.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=385.&lawCode=PUC)

---

[← PUC § 384.5](/codes/puc/7-384.5) · [PUC § 386 →](/codes/puc/8-386) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
