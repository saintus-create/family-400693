---
title: "PUC § 451.1"
description: "(a) For purposes of this section, the following terms have the following meanings: (1) “Covered wildfire” has the same meaning as defined in Section 1701.8…"
slug: codes/puc/1-451.1
position: 344
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=451.1.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `451.1` · **UID:** `PUC:1-451.1`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 3. Rights and Obligations of Public Utilities > 1. Rates

**Citation:** PUC § 451.1 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=451.1.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=451.1.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=451.1.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=451.1.&lawCode=PUC)

---

[← PUC § 451](/codes/puc/1-451) · [PUC § 451.2 →](/codes/puc/1-451.2) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
