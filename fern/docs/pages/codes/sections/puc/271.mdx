---
title: "PUC § 271"
description: "For each advisory board created pursuant to this chapter all of the following are applicable: (a) The commission shall establish the number of, and…"
slug: codes/puc/271
position: 90
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=271.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `271` · **UID:** `PUC:271`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 1.5. Advisory Boards

**Citation:** PUC § 271 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=271.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=271.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=271.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=271.&lawCode=PUC)

---

[← PUC § 270.1](/codes/puc/270.1) · [PUC § 273 →](/codes/puc/273) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
