---
title: "PUC § 325"
description: "(a) The Legislature hereby finds and declares that the commission should have the authority to act swiftly to expedite planning for the long-term recovery…"
slug: codes/puc/325
position: 150
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=325.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `325` · **UID:** `PUC:325`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 2. The Public Utilities Commission: Organization

**Citation:** PUC § 325 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=325.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=325.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=325.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=325.&lawCode=PUC)

---

[← PUC § 324.8](/codes/puc/324.8) · [PUC § 326 →](/codes/puc/326) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
