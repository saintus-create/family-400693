---
title: "PUC § 748.3"
description: "(a) For purposes of this section, all of the following definitions apply: (1) “Above-the-line account” means an account that contains expenses that a…"
slug: codes/puc/2-748.3
position: 577
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=748.3.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `748.3` · **UID:** `PUC:2-748.3`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 4. Regulation of Public Utilities > 2. Rates

**Citation:** PUC § 748.3 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=748.3.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=748.3.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=748.3.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=748.3.&lawCode=PUC)

---

[← PUC § 748.2](/codes/puc/2-748.2) · [PUC § 748.5 →](/codes/puc/2-748.5) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
