---
title: "PUC § 739.4"
description: "(a) Any natural gas customer who enrolls in the CARE program after the effective date of this section, but before October 1, 2001, shall receive the same…"
slug: codes/puc/2-739.4
position: 527
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=739.4.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `739.4` · **UID:** `PUC:2-739.4`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 4. Regulation of Public Utilities > 2. Rates

**Citation:** PUC § 739.4 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=739.4.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=739.4.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=739.4.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=739.4.&lawCode=PUC)

---

[← PUC § 739.3](/codes/puc/2-739.3) · [PUC § 739.5 →](/codes/puc/2-739.5) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
