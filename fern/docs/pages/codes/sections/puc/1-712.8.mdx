---
title: "PUC § 712.8"
description: "(a) For purposes of this section, the following definitions apply: (1) “Current expiration dates” has the same meaning as defined in Section 25548.1 of the…"
slug: codes/puc/1-712.8
position: 492
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=712.8.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `712.8` · **UID:** `PUC:1-712.8`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 4. Regulation of Public Utilities > 1. Generally

**Citation:** PUC § 712.8 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=712.8.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=712.8.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=712.8.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=712.8.&lawCode=PUC)

---

[← PUC § 712.7](/codes/puc/1-712.7) · [PUC § 713 →](/codes/puc/1-713) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
