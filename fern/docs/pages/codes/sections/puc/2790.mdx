---
title: "PUC § 2790"
description: "(a) The commission shall require an electrical or gas corporation to perform home weatherization services for low-income customers if the commission…"
slug: codes/puc/2790
position: 1161
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=2790.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `2790` · **UID:** `PUC:2790`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 2. SPECIFIC PUBLIC UTILITIES > 6. Home Insulation Assistance and Financing

**Citation:** PUC § 2790 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=2790.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=2790.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=2790.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=2790.&lawCode=PUC)

---

[← PUC § 2789](/codes/puc/2789) · [PUC § 2791 →](/codes/puc/2791) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
