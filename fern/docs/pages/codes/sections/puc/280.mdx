---
title: "PUC § 280"
description: "(a) The commission shall develop, implement, and administer a program to advance universal service by providing discounted rates to qualifying schools…"
slug: codes/puc/280
position: 99
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=280.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `280` · **UID:** `PUC:280`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 1.5. Advisory Boards

**Citation:** PUC § 280 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=280.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=280.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=280.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=280.&lawCode=PUC)

---

[← PUC § 278](/codes/puc/278) · [PUC § 280.5 →](/codes/puc/280.5) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
