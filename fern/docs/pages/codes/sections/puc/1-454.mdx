---
title: "PUC § 454"
description: "(a) Except as provided in Section 455, a public utility shall not change any rate or so alter any classification, contract, practice, or rule as to result…"
slug: codes/puc/1-454
position: 354
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=454.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `454` · **UID:** `PUC:1-454`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 3. Rights and Obligations of Public Utilities > 1. Rates

**Citation:** PUC § 454 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=454.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=454.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=454.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=454.&lawCode=PUC)

---

[← PUC § 453.5](/codes/puc/1-453.5) · [PUC § 454.1 →](/codes/puc/1-454.1) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
