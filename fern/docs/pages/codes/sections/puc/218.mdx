---
title: "PUC § 218"
description: "(a) “Electrical corporation” includes every corporation or person owning, controlling, operating, or managing any electric plant for compensation within…"
slug: codes/puc/218
position: 45
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=218.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `218` · **UID:** `PUC:218`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 1. General Provisions and Definitions

**Citation:** PUC § 218 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=218.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=218.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=218.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=218.&lawCode=PUC)

---

[← PUC § 217](/codes/puc/217) · [PUC § 218.3 →](/codes/puc/218.3) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
