---
title: "PUC § 719"
description: "(a) For purposes of this section, terms used in this section shall have the same meaning as those terms are defined in Section 3280. (b) On or before April…"
slug: codes/puc/1-719
position: 497
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=719.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `719` · **UID:** `PUC:1-719`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 4. Regulation of Public Utilities > 1. Generally

**Citation:** PUC § 719 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=719.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=719.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=719.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=719.&lawCode=PUC)

---

[← PUC § 718](/codes/puc/1-718) · [PUC § 727 →](/codes/puc/2-727) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
