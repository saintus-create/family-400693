---
title: "PUC § 387"
description: "(a) For purposes of this article, the following terms have the following meanings: (1) “Carbon-free electrical resource” means a source of electrical…"
slug: codes/puc/8.5-387
position: 252
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=387.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `387` · **UID:** `PUC:8.5-387`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 2.3. Electrical Restructuring > 8.5. Provider of Last Resort

**Citation:** PUC § 387 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=387.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=387.&lawCode=PUC)
...
- **Hierarchy path:** `1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 2.3. Electrical Restructuring > 8.5. Provider of Last Resort`

- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=387.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=387.&lawCode=PUC)

---

[← PUC § 386](/codes/puc/8-386) · [PUC § 388 →](/codes/puc/9-388) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
