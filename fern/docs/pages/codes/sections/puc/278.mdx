---
title: "PUC § 278"
description: "(a) (1) Commencing on July 1, 2003, there is hereby created the Telecommunications Access for Deaf and Disabled Administrative Committee, formerly the Deaf…"
slug: codes/puc/278
position: 98
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=278.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `278` · **UID:** `PUC:278`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 1.5. Advisory Boards

**Citation:** PUC § 278 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=278.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=278.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=278.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=278.&lawCode=PUC)

---

[← PUC § 277](/codes/puc/277) · [PUC § 280 →](/codes/puc/280) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
