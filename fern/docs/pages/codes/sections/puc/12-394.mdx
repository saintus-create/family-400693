---
title: "PUC § 394"
description: "(a) As used in this section, “electric service provider” means an entity that offers electrical service to customers within the service territory of an…"
slug: codes/puc/12-394
position: 259
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=394.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `394` · **UID:** `PUC:12-394`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 2.3. Electrical Restructuring > 12. Consumer Protection

**Citation:** PUC § 394 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=394.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=394.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=394.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=394.&lawCode=PUC)

---

[← PUC § 392.1](/codes/puc/11-392.1) · [PUC § 394.1 →](/codes/puc/12-394.1) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
