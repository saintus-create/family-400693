---
title: "PUC § 3291"
description: "(a) The fund shall be established as a revolving liquidity fund that will pay eligible claims as provided in subdivision (c) and obtain reimbursement from…"
slug: codes/puc/3291
position: 1406
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3291.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `3291` · **UID:** `PUC:3291`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 6. Wildfire > 3. Operation of the Fund

**Citation:** PUC § 3291 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3291.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3291.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3291.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3291.&lawCode=PUC)

---

[← PUC § 3289](/codes/puc/3289) · [PUC § 3292 →](/codes/puc/3292) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
