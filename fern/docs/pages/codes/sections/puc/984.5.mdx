---
title: "PUC § 984.5"
description: "(a) The commission shall compile and regularly update the following information: names and contact numbers of a registered core transport agent, information…"
slug: codes/puc/984.5
position: 853
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=984.5.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `984.5` · **UID:** `PUC:984.5`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 4.7. Core Transport Agent

**Citation:** PUC § 984.5 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=984.5.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=984.5.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=984.5.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=984.5.&lawCode=PUC)

---

[← PUC § 984](/codes/puc/984) · [PUC § 985 →](/codes/puc/985) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
