---
title: "PUC § 786"
description: "(a) On or before March 1, 1984, and annually thereafter, every telephone corporation operating within a service area shall issue to each of its residential…"
slug: codes/puc/3-786
position: 646
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=786.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `786` · **UID:** `PUC:3-786`
...
**Citation:** PUC § 786 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=786.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=786.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=786.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=786.&lawCode=PUC)

---

[← PUC § 785.7](/codes/puc/3-785.7) · [PUC § 787 →](/codes/puc/3-787) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
