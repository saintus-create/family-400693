---
title: "PUC § 8388.5"
description: "(a) The commission shall establish an expedited utility distribution infrastructure undergrounding program consistent with this section. (b) Only a large…"
slug: codes/puc/8388.5
position: 1983
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=8388.5.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `8388.5` · **UID:** `PUC:8388.5`

**Location:** 4.1. PROVISIONS APPLICABLE TO PRIVATELY OWNED AND PUBLICLY OWNED PUBLIC UTILITIES > 6. Wildfire Mitigation

**Citation:** PUC § 8388.5 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=8388.5.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=8388.5.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=8388.5.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=8388.5.&lawCode=PUC)

---

[← PUC § 8388](/codes/puc/8388) · [PUC § 8389 →](/codes/puc/8389) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
