---
title: "PUC § 745"
description: "(a) For purposes of this section, “time-variant pricing” includes time-of-use rates, critical peak pricing, and real-time pricing, but does not include…"
slug: codes/puc/2-745
position: 572
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=745.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `745` · **UID:** `PUC:2-745`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 4. Regulation of Public Utilities > 2. Rates

**Citation:** PUC § 745 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=745.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=745.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=745.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=745.&lawCode=PUC)

---

[← PUC § 744.5](/codes/puc/2-744.5) · [PUC § 746 →](/codes/puc/2-746) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
