---
title: "PUC § 281"
description: "(a) The commission shall develop, implement, and administer the California Advanced Services Fund to encourage deployment of high-quality advanced…"
slug: codes/puc/281
position: 101
---
...
<Note>
Snapshot updated by the state: **August 08, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=281.&lawCode=PUC).
</Note>

**Code:** Public Utilities Code (`PUC`) · **Section:** `281` · **UID:** `PUC:281`

**Location:** 1. REGULATION OF PUBLIC UTILITIES > 1. PUBLIC UTILITIES ACT > 1.5. Advisory Boards

**Citation:** PUC § 281 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=281.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=281.&lawCode=PUC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=281.&lawCode=PUC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=281.&lawCode=PUC)

---

[← PUC § 280.5](/codes/puc/280.5) · [PUC § 281.1 →](/codes/puc/281.1) · [Browse Public Utilities Code](/codes/puc) · [Search corpus](/codes/search)
