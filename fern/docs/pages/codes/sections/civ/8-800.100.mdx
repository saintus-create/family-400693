---
title: "CIV § 800.100"
description: "(a) When the owner of a floating home marina enters into a written listing agreement with a licensed real estate broker, as defined in Article 1 (commencing…"
slug: codes/civ/8-800.100
position: 495
---
...
<Note>
Snapshot updated by the state: **August 26, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=800.100.&lawCode=CIV).
</Note>

**Code:** Civil Code (`CIV`) · **Section:** `800.100` · **UID:** `CIV:8-800.100`

**Location:** 2. ESTATES IN REAL PROPERTY > 2.7. Floating Home Residency Law > 8. Transfer of a Floating Home Marina

**Citation:** CIV § 800.100 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=800.100.&lawCode=CIV](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=800.100.&lawCode=CIV)
...
- **Hierarchy path:** `2. ESTATES IN REAL PROPERTY > 2.7. Floating Home Residency Law > 8. Transfer of a Floating Home Marina`

- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=800.100.&lawCode=CIV](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=800.100.&lawCode=CIV)

---

[← CIV § 800.91](/codes/civ/7-800.91) · [CIV § 800.200 →](/codes/civ/9-800.200) · [Browse Civil Code](/codes/civ) · [Search corpus](/codes/search)
