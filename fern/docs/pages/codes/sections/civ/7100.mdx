---
title: "CIV § 7100"
description: "(a) Every retail grocery store or grocery department within a general retail merchandise store which uses a point-of-sale system shall cause to have a…"
slug: codes/civ/7100
position: 3799
---
...
<Note>
Snapshot updated by the state: **August 26, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=7100.&lawCode=CIV).
</Note>

**Code:** Civil Code (`CIV`) · **Section:** `7100` · **UID:** `CIV:7100`

**Location:** 5.5. AUTOMATIC CHECKOUT SYSTEM > 4. MOTION PICTURES

**Citation:** CIV § 7100 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=7100.&lawCode=CIV](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=7100.&lawCode=CIV)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=7100.&lawCode=CIV](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=7100.&lawCode=CIV)

---

[← CIV § 6876](/codes/civ/6876) · [CIV § 7101 →](/codes/civ/7101) · [Browse Civil Code](/codes/civ) · [Search corpus](/codes/search)
