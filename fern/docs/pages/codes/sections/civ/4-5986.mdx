---
title: "CIV § 5986"
description: "(a) Subject to compliance with Section 6150, which requires the board to provide notice of a meeting with the members to discuss, among other things…"
slug: codes/civ/4-5986
position: 3698
---
...
<Note>
Snapshot updated by the state: **August 26, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5986.&lawCode=CIV).
</Note>

**Code:** Civil Code (`CIV`) · **Section:** `5986` · **UID:** `CIV:4-5986`

**Location:** 5. Common Interest Developments > 4. MOTION PICTURES > 10. Dispute Resolution and Enforcement > 4. Civil Action

**Citation:** CIV § 5986 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5986.&lawCode=CIV](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5986.&lawCode=CIV)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5986.&lawCode=CIV](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=5986.&lawCode=CIV)

---

[← CIV § 5985](/codes/civ/4-5985) · [CIV § 6100 →](/codes/civ/6100) · [Browse Civil Code](/codes/civ) · [Search corpus](/codes/search)
