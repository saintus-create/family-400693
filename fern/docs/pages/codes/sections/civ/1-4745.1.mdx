...
<Note>
Snapshot updated by the state: **August 26, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4745.1.&lawCode=CIV).
</Note>

**Code:** Civil Code (`CIV`) · **Section:** `4745.1` · **UID:** `CIV:1-4745.1`

**Location:** 5. Common Interest Developments > 4. MOTION PICTURES > 5. Property Use and Maintenance > 1. Protected Uses

**Citation:** CIV § 4745.1 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4745.1.&lawCode=CIV](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4745.1.&lawCode=CIV)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4745.1.&lawCode=CIV](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=4745.1.&lawCode=CIV)

---

[← CIV § 4745](/codes/civ/1-4745) · [CIV § 4746 →](/codes/civ/1-4746) · [Browse Civil Code](/codes/civ) · [Search corpus](/codes/search)
