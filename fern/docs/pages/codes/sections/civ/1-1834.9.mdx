---
title: "CIV § 1834.9"
description: "(a) Manufacturers and contract testing facilities shall not use traditional animal test methods within this state for which an appropriate alternative test…"
slug: codes/civ/1-1834.9
position: 2169
---
...
<Note>
Snapshot updated by the state: **August 26, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1834.9.&lawCode=CIV).
</Note>

**Code:** Civil Code (`CIV`) · **Section:** `1834.9` · **UID:** `CIV:1-1834.9`

**Location:** 3. DEPOSIT > 2. Deposit for Keeping > 1. General Provisions [1833. - [1840.]]

**Citation:** CIV § 1834.9 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1834.9.&lawCode=CIV](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1834.9.&lawCode=CIV)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1834.9.&lawCode=CIV](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1834.9.&lawCode=CIV)

---

[← CIV § 1834.8](/codes/civ/1-1834.8) · [CIV § 1834.9.3 →](/codes/civ/1-1834.9.3) · [Browse Civil Code](/codes/civ) · [Search corpus](/codes/search)
