---
title: "FIN § 587"
description: "(a) If the commissioner finds that any of the factors set forth in paragraph (1) and the factor set forth in paragraph (2) are true with respect to a…"
slug: codes/fin/4-587
position: 191
---
...
<Note>
Snapshot updated by the state: **July 10, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=587.&lawCode=FIN).
</Note>

**Code:** Financial Code (`FIN`) · **Section:** `587` · **UID:** `FIN:4-587`

**Location:** 1. FINANCIAL INSTITUTIONS > 6. Enforcement > 4. Suspension or Removal of Subject Persons

**Citation:** FIN § 587 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=587.&lawCode=FIN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=587.&lawCode=FIN)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=587.&lawCode=FIN](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=587.&lawCode=FIN)

---

[← FIN § 586](/codes/fin/4-586) · [FIN § 588 →](/codes/fin/4-588) · [Browse Financial Code](/codes/fin) · [Search corpus](/codes/search)
