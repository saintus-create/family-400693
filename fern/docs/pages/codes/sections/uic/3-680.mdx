---
title: "UIC § 680"
description: "(a) Notwithstanding any other provision of law, when motion picture production workers are employed by one or more affiliated entities of a motion picture…"
slug: codes/uic/3-680
position: 174
---
...
<Note>
Snapshot updated by the state: **July 17, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=680.&lawCode=UIC).
</Note>

**Code:** Unemployment Insurance Code (`UIC`) · **Section:** `680` · **UID:** `UIC:3-680`

**Location:** 1. UNEMPLOYMENT AND DISABILITY COMPENSATION > 1. UNEMPLOYMENT COMPENSATION > 3. Scope or Coverage > 3. Subject Employers

**Citation:** UIC § 680 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=680.&lawCode=UIC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=680.&lawCode=UIC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=680.&lawCode=UIC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=680.&lawCode=UIC)

---

[← UIC § 679](/codes/uic/3-679) · [UIC § 682 →](/codes/uic/3-682) · [Browse Unemployment Insurance Code](/codes/uic) · [Search corpus](/codes/search)
