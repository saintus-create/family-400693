...
<Note>
Snapshot updated by the state: **July 17, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3301.&lawCode=UIC).
</Note>

**Code:** Unemployment Insurance Code (`UIC`) · **Section:** `3301` · **UID:** `UIC:3301`

**Location:** 1. UNEMPLOYMENT AND DISABILITY COMPENSATION > 2. DISABILITY COMPENSATION > 7. Paid Family Leave

**Citation:** UIC § 3301 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3301.&lawCode=UIC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3301.&lawCode=UIC)
...
(g) This section shall remain in effect only until July 1, 2028, and as of that date is repealed.

## History

(History: Amended by Stats. 2025, Ch. 772, Sec. 1. (SB 590) Effective January 1, 2026. Conditionally repealed on or before July 1, 2028, by its own provisions. See later operative version added by Sec. 2 of Stats. 2025, Ch. 772.)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3301.&lawCode=UIC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3301.&lawCode=UIC)

---

[← UIC § 3300](/codes/uic/3300) · [UIC § 3301 →](/codes/uic/3301-2) · [Browse Unemployment Insurance Code](/codes/uic) · [Search corpus](/codes/search)
