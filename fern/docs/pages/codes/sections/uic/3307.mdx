---
title: "UIC § 3307"
description: "(a) When an employee requests for the first time leave because of a qualifying exigency arising out of the covered active duty or call to covered active…"
slug: codes/uic/3307
position: 817
---
...
<Note>
Snapshot updated by the state: **July 17, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3307.&lawCode=UIC).
</Note>

**Code:** Unemployment Insurance Code (`UIC`) · **Section:** `3307` · **UID:** `UIC:3307`

**Location:** 1. UNEMPLOYMENT AND DISABILITY COMPENSATION > 2. DISABILITY COMPENSATION > 7. Paid Family Leave

**Citation:** UIC § 3307 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3307.&lawCode=UIC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3307.&lawCode=UIC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3307.&lawCode=UIC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=3307.&lawCode=UIC)

---

[← UIC § 3306](/codes/uic/3306) · [UIC § 3308 →](/codes/uic/3308) · [Browse Unemployment Insurance Code](/codes/uic) · [Search corpus](/codes/search)
