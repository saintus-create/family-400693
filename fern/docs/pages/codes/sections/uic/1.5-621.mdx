---
title: "UIC § 621"
description: "“Employee” means all of the following: (a) Any officer of a corporation. (b) Any individual providing labor or services for remuneration has the status of…"
slug: codes/uic/1.5-621
position: 132
---
...
<Note>
Snapshot updated by the state: **July 17, 2026** — dated research snapshot. Verify current text and effective date at the [official California Legislative Information source](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=621.&lawCode=UIC).
</Note>

**Code:** Unemployment Insurance Code (`UIC`) · **Section:** `621` · **UID:** `UIC:1.5-621`

**Location:** 1. UNEMPLOYMENT AND DISABILITY COMPENSATION > 1. UNEMPLOYMENT COMPENSATION > 3. Scope or Coverage > 1.5. Employee

**Citation:** UIC § 621 · **Official:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=621.&lawCode=UIC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=621.&lawCode=UIC)
...
- **Official URL:** [https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=621.&lawCode=UIC](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=621.&lawCode=UIC)

---

[← UIC § 611](/codes/uic/1-611) · [UIC § 621.5 →](/codes/uic/1.5-621.5) · [Browse Unemployment Insurance Code](/codes/uic) · [Search corpus](/codes/search)
