---
title: "Family Code"
description: "Complete text of the California Family Code — 1,636 sections, organized by official divisions."
slug: "codes/fam"
---

# Family Code

**1,636 sections** · **Snapshot updated by the source: November 27, 2025**

The complete statutory text of the Family Code, organized by its official
divisions. Locate sections with the [corpus search](/codes/search), or ask **Ask AI**,
which is indexed against this same snapshot.

## Contents

- [Family Code: Division 1–20](/codes/fam/div-1-div-20)

## Downloads

- [Download the `FAM.jsonl.gz` dataset](https://github.com/saintus-create/family-400693/blob/main/fern/assets/corpus/law/FAM.jsonl.gz)
