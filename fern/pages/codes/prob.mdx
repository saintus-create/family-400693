---
title: "Probate Code"
description: "Complete text of the California Probate Code — 2,711 sections, organized by official divisions."
slug: "codes/prob"
---

# Probate Code

**2,711 sections** · **Snapshot updated by the source: November 27, 2025**

The complete statutory text of the Probate Code, organized by its official
divisions. Locate sections with the [corpus search](/codes/search), or ask **Ask AI**,
which is indexed against this same snapshot.

## Contents

- [Probate Code: Division 1–11](/codes/prob/div-1-div-11)

## Downloads

- [Download the `PROB.jsonl.gz` dataset](https://github.com/saintus-create/family-400693/blob/main/fern/assets/corpus/law/PROB.jsonl.gz)
